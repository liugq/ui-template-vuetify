<template>
  <div>
    ...
    >
      <v-row
        class="lightbox pl-2 pt-2 pb-0 fill-height white--text"
        align="end"
        dense
      >
        <v-col class="pb-0">
      ...
      <v-tab-item value="Setting">
        <v-content class="pa-1">
          ...
          <v-row>
            ...
            <v-col cols="6">
              <v-switch
                v-model="leftDrawer.img.display"
                class="mt-0 pt-0 float-right"
                dense
                hide-details
              ></v-switch>
